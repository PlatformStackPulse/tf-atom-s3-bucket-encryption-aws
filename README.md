...
|------|-------------|------|---------|:--------:|
| <a name="input_bucket_id"></a> [bucket\_id](#input\_bucket\_id) | ID (name) of the S3 bucket to configure encryption for | `string` | n/a | yes |
| <a name="input_attributes"></a> [attributes](#input\_attributes) | ID element. Additional attributes (e.g. `workers` or `cluster`) to add to `id`,<br/>in the order they appear in the list. New attributes are appended to the<br/>end of the list. The elements of the list are joined by the `delimiter`<br/>and treated as a single ID element. | `list(string)` | `[]` | no |
| <a name="input_bucket_key_enabled"></a> [bucket\_key\_enabled](#input\_bucket\_key\_enabled) | Whether to use S3 Bucket Key for SSE-KMS (reduces KMS costs) | `bool` | `true` | no |
...
| <a name="input_kms_master_key_id"></a> [kms\_master\_key\_id](#input\_kms\_master\_key\_id) | KMS key ARN or ID for encryption. If null, uses AWS-managed key (aws/s3) | `string` | `null` | no |
...
| <a name="input_sse_algorithm"></a> [sse\_algorithm](#input\_sse\_algorithm) | Server-side encryption algorithm (aws:kms, aws:kms:dsse, or AES256) | `string` | `"aws:kms"` | no |
...
| <a name="output_id"></a> [id](#output\_id) | ID of the encryption configuration |
| <a name="output_sse_algorithm"></a> [sse\_algorithm](#output\_sse\_algorithm) | The encryption algorithm in use |
<!-- END_TF_DOCS -->
